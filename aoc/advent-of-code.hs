        ...
        (testGroup
             ...
             , testGroup
                   ...
                   [ testGroup
                         "*"
                         [ testCase "1" $
                           day2 Fst [[5, 1, 9, 5], [7, 5, 3], [2, 4, 6, 8]] @?=
                           18
                   ...
                   , testGroup
                         "**"
                         [ testCase "1" $
                           day2 Snd [[5, 9, 2, 8], [9, 4, 7, 3], [3, 8, 6, 5]] @?=
                           9
             ...
             , testGroup
                   ...
                   , testGroup
                         ...
                         , testCase "4" $
                           day4 Snd "iiii oiii ooii oooi oooo" @?= True
             ...
             , testGroup
                   ...
                   [ testGroup
                         "*"
                         [ testCase "1" $
                           day5 Fst (V.fromList [0, 3, 0, 1, -3]) @?= 5
                           -- , testCase "#" $ day5 Fst day5input @?= 0 -- 318883 (took 15s)
                          ]
                   , testGroup
                         "**"
                         [ testCase "1" $
                           day5 Snd (V.fromList [0, 3, 0, 1, -3]) @?= 10
